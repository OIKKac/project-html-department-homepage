...
function SLB(url, type)
{
	...
	if(url) {
		...
		if(type == 'image') {			
			...
			b.innerHTML += "<div class='SLB_close' onclick='SLB();' title='´Ý±â'><img src='../images/comm/icon_close.png' alt='' /></div>";;
		} else if (type == 'iframe') {
			...
			if(arguments[4]) {
				b.innerHTML += "<div class='SLB_close' onclick='SLB();' title='´Ý±â'>´Ý±â</div>";
			}
...
function tryReHeight(sign) {
	var getFFVersion=navigator.userAgent.substring(navigator.userAgent.indexOf("Firefox")).split("http://gitb.hannam.ac.kr/")[1];
